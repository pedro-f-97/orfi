...
MENSAGENS = {
    "pt": {
        ...
        "erro_ficheiro": "Erro '{erro}' no ficheiro {ficheiro}",
        ...
        "tratamento_organizar_copia": "copiados.",
        "tratamento_organizar_movimento": "movidos.",
        "tratamento_datar_copia": "copiados e datados.",
        ...
        "tratamento_reverter_copia": "copiados.",
    ...
    "en": {
        ...
        "erro_ficheiro": "Error '{erro}' on file {ficheiro}",
        ...
        "tratamento_organizar_copia": "copied.",
        "tratamento_organizar_movimento": "moved.",
        "tratamento_datar_copia": "copied and dated.",
        "tratamento_datar_movimento": "dated.",
        "ficheiros_tratados": "Done, {total} files {tratamento}",
        "ficheiros_seriam_tratados": "Done, {total} files would have been {tratamento}",
        #reverter
        "nada_para_reverter": "Nothing to revert.",
        "nada_para_reverter_simula": "Nothing would be reverted.",
        "ficheiros_revertidos": "Reverted, {total} files {tratamento}",
        "ficheiros_seriam_revertidos": "Reverted, {total} files would have been {tratamento}",
        "ficheiro_ignorado": "File ignored: {ficheiro}",
        "ficheiro_seria_ignorado": "File would be ignored: {ficheiro}",
        "tratamento_reverter_copia": "copied.",
