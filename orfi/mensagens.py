...
MENSAGENS = {
    "pt": {
        ...
        "erro_copiar_ficheiro": "Erro '{erro}' no ficheiro {ficheiro}: {erro}",
        ...
        "erro_mover_ficheiro": "Erro '{erro}' no ficheiro {ficheiro}: {erro}",
